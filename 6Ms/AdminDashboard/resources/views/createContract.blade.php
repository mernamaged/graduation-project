            ...
            <div class="card bordered">
                <div class="card-body">
                    ...
                    <form action="{{ route('contracts.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="text" name="contract_budget" placeholder="contract budget" class="form-control mb-3">
                        <input type="text" name="contract_duration" placeholder="date" class="form-control mb-3">
