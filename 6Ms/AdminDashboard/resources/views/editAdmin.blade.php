        ...
        <div class="col-12 col-md-6">
            <div class="card bordered">
                <div class="card-body">
                    ...
                    <form id="editForm" action="{{ route('admins.update', $admin->admin_id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <input type="file" name="admin_img" class="form-control mb-3">
