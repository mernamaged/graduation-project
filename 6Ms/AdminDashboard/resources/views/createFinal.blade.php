        ...
        <div class="col-12 col-md-6">
            <div class="card bordered">
                <div class="card-body">
                    ...
                    <form action="{{ route('endProducts.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @foreach ($superclasses as $superclass)
                            <input type="hidden" name="prod_id" value="{{$superclass->prod_id}}">
                        @endforeach
                        <input type="text" name="brand_name" placeholder="brand name" class="form-control mb-3">
