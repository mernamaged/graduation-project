...
<head>
    ...
    <title>Raw Material create </title>
            ...
            <div class="card bordered">
                <div class="card-body">
                    ...
                    <form action="{{ route('rawMaterials.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @endforeach
                        <input type="text" name="material_type" placeholder="type" class="form-control mb-3">
                        <input type="text" name="price_raw" placeholder="price" class="form-control mb-3">
