            ...
            <div class="card bordered">
                <div class="card-body">
                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="text" name="p_name" placeholder="Product Name" class="form-control mb-3">
                        <input type="text" name="p_price" placeholder="Price" class="form-control mb-3">
                        <input type="text" name="product_type" placeholder="Product type" class="form-control mb-3">
